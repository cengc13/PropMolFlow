...
import dgl
from propflowmol.models.vector_field import EndpointVectorField
from torch.nn.functional import one_hot
from torch.distributions.categorical import Categorical
from propflowmol.data_processing.utils import get_edge_batch_idxs
import torch.nn.functional as F

from propflowmol.utils.ctmc_utils import purity_sampling
...
####################### conditional 
    def forward(self, g: dgl.DGLGraph, t: torch.Tensor, 
        ...
        with g.local_scope():
            ...
            is_conditional = len(t.shape) > 1 and self.conditional_generation
