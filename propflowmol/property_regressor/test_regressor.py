...
from propflowmol.property_regressor.train_regressor import GVPRegressorModule
from propflowmol.data_processing.dataset import collate
from propflowmol.data_processing.dataset import PROPERTY_MAP
...
def main():
    ...
    parser.add_argument('--properties_values', type=str, help='Path to properties file (optional)')
    parser.add_argument('--property_name', type=str, help='Name of property to predict (optional)')
    ...
    #     results['true_properties'] = filtered_properties
