from propflowmol.models.gvp import GVPConv, _norm_no_nan, GVP, _rbf
from propflowmol.models.vector_field import NodePositionUpdate, EdgeUpdate
...
class GVPRegressor(nn.Module):
    ...
    def __init__(self, 
        ...
        n_atom_types = 5  # From dataset.py
